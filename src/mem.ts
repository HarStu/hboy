...
class Mem {
  ...
  private vram: Uint8Array; // 8KB Video RAM, located 0x8000-0x9FFF

  private eramBanks: Uint8Array[]; // External RAM banks
  private cerb: number; // Current eram bank. Defaults to -1 (no eram banks on cart)

  private wram: Uint8Array; // 8KB Work RAM, located 0xC000-0xDFFF
  private oam: Uint8Array; // Object Attribute Memory
  private io: Uint8Array; // I/O Registers
  private hram: Uint8Array; // High RAM
  private ie: Uint8Array; // Interupt Enable Register
